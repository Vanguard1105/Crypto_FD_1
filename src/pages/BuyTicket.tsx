      ...
      <div className="px-4">
              ...
              <div>
                ...
                <div className="relative flex items-center">
                  <button
                    ...
                    className={`absolute left-1 px-4 selft-center text-lg font-bold text-[#81182c]`}
                  >
                    -
                  </button>
                  <input
                  ...
                  <button
                    onClick={() => setPrediction((Number(prediction || latestPrice) + 0.001).toFixed(3))}
                    className={`absolute right-1 px-4 selft-center text-lg font-bold  text-[#286e34]`}
                  >
                    +
                  </button>
                </div>
        ...
        {ticketHistory.length > 0 && (
          <div className="mb-8">
            ...
            <div className={`grid grid-cols-5 place-items-stretch gap-1 text-md font-semibold items-center px-2`}>
