...
const SetPassword = () => {
  ...
  return (
    <div className={`flex flex-col items-center justify-between min-h-screen pt-1 ${  
      ...
      <div className="w-full max-w-sm mb-2 px-5">
        <form onSubmit={handleSetPassword} className="space-y-1">
          ...
          <button
            type="submit"
            className="w-full bg-blue-500 text-white py-3 rounded-lg text-sm font-medium h-[48px]
